...
ARP的作用是找到IP地址对应的MAC地址，然后保存在ARP表中。ARP只能在同一个子网的主机和路由器上解析IP地址。
...
HTTP是无状态协议，如果需要进行状态的管理，那么需要使用Cookie技术。Cookie保存了
...
<div align="center"><img src="images/image-20200913115053266.png" />
